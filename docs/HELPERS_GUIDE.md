...
UrlHelper::redirect('/login'); // Redirect ไปหน้า login
...
// Success
ResponseHelper::success(['user' => $user], 'User retrieved');

// Error
ResponseHelper::error('Invalid input', ['email' => 'Required'], 400);

// Not Found
ResponseHelper::notFound('Product not found');

// Validation
ResponseHelper::validationError(['name' => 'Name is required']);
```
